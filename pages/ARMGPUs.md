...
Finally, the Pi only has a single lane PCIe Gen 3 x 1. This isn't necessarily a dealbreaker. This entire project is predicated on the fact that PCIe bandwidth is underutilized in inference tasks. However, that does mean filling 32GB of GPU memory would take half a minute. Ideally I'd like at least Gen3 x 4.
