...
The AG32 is available in quantity for **eighty cents** [on LCSC](https://www.lcsc.com/product-detail/C41397171.html). Can you beat that? No, you can't.
...
These aren't direct drop-in replacements; there are quirks with the clocks and some different behavior with the peripherals between the STM32, GD32, and AG32. But the overall contour of the landscape is that the AG32 micros are STM32s with a 2k CLPD or FPGA bolted on.

As far as the FPGA fabric of the AG32 is concerned, [official documentation](https://www.agm-micro.com/upload/userfiles/files/AGRV2K_Rev_3_0.pdf) and Chinese language blogs (here's a [page on Scribd](https://www.scribd.com/document/808084197/MANUAL-Supra-6-2%E5%BF%AB%E9%80%9F%E5%85%A5%E9%97%A8)) refer to them as equivalent to Altera Cyclone IV EP4CE10/EP4CE15 parts, but _not quite_. The basic specs for the FPGA part of the AG32 are:
...
In short, the AG32 is equivalent to an [STM32F303](https://www.st.com/en/microcontrollers-microprocessors/stm32f303.html) and a cut-down version of the [Cyclone IV EP4CE6](https://www.intel.com/content/www/us/en/products/sku/210472/cyclone-iv-ep4ce6-fpga/specifications.html), or roughly [EPM570](https://www.intel.com/content/www/us/en/products/sku/210266/max-ii-epm570-cpld/specifications.html)-ish. If you want a mental anchor of what the FPGA is, think of it as an [iCE40 LP2K](https://www.latticesemi.com/ice40). These aren't exact comparisons, but we're in the ballpark of what the AG32 actually is. 
